...
void Assets::load_fonts() {
    menu_font = LoadFontEx("data/fonts/ARCADE_N.ttf", 256, nullptr, 128);
}

void Assets::unload_fonts() {
    UnloadFont(menu_font);
}

void Assets::load_images() {
...
void Assets::draw_image(Texture2D image, Vector2 pos, float size) {
    this->draw_image(image, pos, size, size);
}

void Assets::draw_image(Texture2D image, Vector2 pos, float width, float height) {
...
void Assets::unload_sprite(sprite &sprite) {
...
void Assets::draw_sprite(sprite &sprite, Vector2 pos, float size) {
    this->draw_sprite(sprite, pos, size, size);
}

void Assets::draw_sprite(sprite &sprite, Vector2 pos, float width, float height) {
    this->draw_image(sprite.frames[sprite.frame_index], pos, width, height);
